...
public class SysUsers implements Serializable{
	...
	public String toString() {
		...
		+"suRegisterTime:"+suRegisterTime+","
		+"suQqId:"+suQqId+","
		+"suWeixinId:"+suWeixinId+","
		+"suGrade:"+suGrade+","
		...
		+"suWeiboId:"+suWeiboId+","
		+"suIdcard:"+suIdcard+","
		+"suJobTitle:"+suJobTitle+","
		+"suAliases:"+suAliases+","
		+"suJobNo:"+suJobNo+","
		+"companyId:"+companyId+","
		+"suTel2:"+suTel2+","
		+"suAccountStatus:"+suAccountStatus+","
		+"suValidateCode:"+suValidateCode+","
		+"suValidateEndTime:"+suValidateEndTime+","
		+"suValid:"+suValid+","
