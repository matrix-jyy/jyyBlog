...
public class WebUtil {
	...
	public static <T> T getService(JspContext jspContext, String name) {
		return (T)((PageContext)jspContext).getServletContext().getAttribute(name);
	}
