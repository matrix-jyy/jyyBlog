...
<div class="ibox-content">
		...
		<c:if test="${obj ne null }">
			<input type="hidden" name="paramId" value="${obj.paramId }">
		</c:if>
		<div class="form-group">
			<label class="col-sm-2 control-label">参数编码<span class="text-danger">*</span></label>
			<div class="col-sm-8">
				<input type="text" dataType="*1-100" class="form-control" name="paramCode"
					value="<c:out value="${obj.paramCode }"></c:out>"  nullmsg="编码不能为空">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-8">
				<textarea  class="form-control" name="paramValue" cols="8"
					 datatype="*" nullmsg="值不能为空"><c:out value="${obj.paramValue }"></c:out></textarea>
			</div>
		</div>
		<div class="form-group ">
