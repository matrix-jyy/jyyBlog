...
<div class="row" >
		...
		<form class="form-inline" id="serchform" onsubmit="javascripr:return false;">
			<div class="form-group mr-20">
				<label for="exampleInputName2">数据字典</label>
				<input name="cataName" type="text" class="form-control">
			</div>
			
			<div class="form-group  mr-20">
				<label class="exampleInputName2">父级分类</label>
		...
		<table id="mgrid" >
			<thead>
				<tr>
					...
					<th data-field="parentName" data-sortable="true">数据字典类型</th>
					<th data-field="cataName" data-sortable="true">数据值</th>
					<th data-field="cataSequnce" data-sortable="true">排序</th>
	...
	var myGrid;
		...
		$(function(){
			...
			delPath="${path}/admin/dictionary/del";
			</matrix:btn>
			 myGrid=MGrid.initGrid({
				 url:"${path}/admin/dictionary/showList",
				 delUrl:delPath
			 });
		});
		...
		function openAdd() {
			layer.open({
				...
				content : [ '${path}/admin/dictionary/editForm']
			}); 
		}
		</matrix:btn>
		<matrix:btn value="user:edit">
		...
		function openEdit(id) {
			layer.open({
				...
				area : [ MUI.SIZE_L, '400px' ],
				maxmin : true,
				content : [ '${path}/admin/dictionary/editForm?id=' + id]
			});
		}
		</matrix:btn>
		$(".select2").select2();
