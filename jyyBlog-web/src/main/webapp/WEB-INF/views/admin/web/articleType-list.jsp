...
<body class="gray-bg">
    <div class="wrapper wrapper-content  animated fadeInRight">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" style="min-height: 400px">
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label">文章类型Code</label>
								<div class="col-sm-3">
									<input id="code" name="code" type="text" class="form-control "
										nullmsg="code不能为空" datatype="*">
								</div>
							</div>
							<div class="form-group">
		...
		<div class="col-sm-8">
		<input value="1"
				name="artTypeIcon" id="artTypeIcon" class="form-control  upload-input"
		...
		$.AjaxProxy({
				...
				.invoke(
						...
						function(loj) {
							...
							$("#artTypeIcon_hide").val(loj.getString(0, "artTypeIcon"));
							$("#artTypeIcon").val(loj.getString(0, "artTypeIcon"));
							$("#artTypeIcon_img").attr("src",loj.getString(0, "artTypeIcon")).show();
							
							
							
							$("#sort").val(loj.getString(0, "artTypeSort"));
							$("#code").val(loj.getString(0, "code"));
