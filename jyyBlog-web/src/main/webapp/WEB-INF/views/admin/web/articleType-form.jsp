...
<body style="height: 100%; overflow: hidden;">
	<div class="ibox-content">
		<form class="form-horizontal " id="dataform"
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">文章code<span class="text-danger">*</span></label>
				<div class="col-sm-3">
					<input name="code" type="text" class="form-control " nullmsg="code不能为空"
						datatype="*" errormsg="code不为空">					
				</div>
			</div>
